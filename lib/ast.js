...
AST.Note.prototype.add_to_score = function(score) {
  var params = {'P5': parseInt(this.params[0]),
                'P6': parseFloat(this.params[1])};
  score.notes.push(new Model.Note(this.time, this.instrument_number, this.duration, params, score));
};
